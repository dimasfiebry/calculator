...
// Fungsi untuk menampilkan detail bahan
function tampilkanDetailBahan(namaBahan) {
  // Ambil elemen-elemen detail untuk setiap zat gizi dari HTML
  ...
  var detailLemakElemen = document.getElementById("detailLemak");
  var detailKarbohidratElemen = document.getElementById("detailKH");
  var detailSeratElemen = document.getElementById("detailSerat");
  var detailAbuElemen = document.getElementById("detailAbu");
  var detailKalsiumElemen = document.getElementById("detailKalsium");
  var detailFosforElemen = document.getElementById("detailFosfor");
  var detailBesiElemen = document.getElementById("detailBesi");
  var detailNatriumElemen = document.getElementById("detailNatrium");
  var detailKaliumElemen = document.getElementById("detailKalium");
  var detailTembagaElemen = document.getElementById("detailTembaga");
  var detailSengElemen = document.getElementById("detailSeng");
  var detailRetinolElemen = document.getElementById("detailRetinol");
  var detailBKarotenElemen = document.getElementById("detailBKar");
  var detailKarotenTotalElemen = document.getElementById("detailKarTotal");
  var detailThiaminElemen = document.getElementById("detailThiamin");
  var detailRiboflavinElemen = document.getElementById("detailRiboflavin");
  var detailNiasinElemen = document.getElementById("detailNiasin");
  ...
  if (dataBahan.hasOwnProperty(namaBahan)) {
    ...
    detailEnergiElemen.textContent = "-";
    detailProteinElemen.textContent = "-";
    detailLemakElemen.textContent = "-";
    detailKarbohidratElemen.textContent = "-";
    detailSeratElemen.textContent = "-";
    detailAbuElemen.textContent = "-";
    detailKalsiumElemen.textContent = "-";
    detailFosforElemen.textContent = "-";
    detailBesiElemen.textContent = "-";
    detailNatriumElemen.textContent = "-";
    detailKaliumElemen.textContent = "-";
    detailTembagaElemen.textContent = "-";
    detailSengElemen.textContent = "-";
    detailRetinolElemen.textContent = "-";
    detailBKarotenElemen.textContent = "-";
    detailKarotenTotalElemen.textContent = "-";
    detailThiaminElemen.textContent = "-";
    detailRiboflavinElemen.textContent = "-";
    detailNiasinElemen.textContent = "-";
    detailVitaminCElemen.textContent = "-";
    detailBDDElemen.textContent = "-";
  }
}
...
function cariBahan() {
  ...
  var namaBahanInputValue = namaBahanInput.value.trim().toLowerCase();

  // Jika input kosong, bersihkan hasil pencarian dan keluar dari fungsi
  if (namaBahanInputValue === "") {
  ...
  // Lakukan pencarian berdasarkan nama bahan
  for (var bahan in dataBahan) {
    if (bahan.toLowerCase().includes(namaBahanInputValue)) {
      hasilPencarian[bahan] = dataBahan[bahan];
    }
  }
  ...
  // Tentukan nama bahan yang ingin ditampilkan (dapatkan dari hasil pencarian atau input pengguna)
  var namaBahanPilihan = Object.keys(hasilPencarian)[0];

  // Tampilkan detail bahan
  tampilkanDetailBahan(namaBahanPilihan);
}

// Fungsi untuk menampilkan hasil pencarian
function tampilkanHasilPencarian(data) {
  // (Tentukan elemen-elemen atau logika lain untuk menampilkan hasil pencarian jika diperlukan)
}
