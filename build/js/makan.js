...
// Panggil fungsi ini ketika Anda ingin menampilkan hasil secara dinamis
// Contoh pemanggilan: tampilkanHasilPencarianSecaraDinamis(hasilPencarian);
...
//   // Fungsi untuk menambahkan bahan
//   function tambahBahan() {
//     var namaBahan = namaBahanInput.value;
...
//     var newBahan = document.createElement("div");
//     newBahan.className = "flex flex-row items-center space-y-2 pt-4 gap-4 justify-center added-ingredient";

//     var inputNamaBahan = document.createElement("input");
//     inputNamaBahan.type = "text";
//     inputNamaBahan.value = namaBahan;
//     inputNamaBahan.disabled = true;
//     inputNamaBahan.className = "w-44 optional:text-gray-800 optional:text-xs bg-transparent border border-gray-400 hover:border-gray-500 px-4 py-2 translate-y-1 rounded leading-tight focus:outline-none";

//     var inputBeratBahan = document.createElement("input");
//     inputBeratBahan.type = "number";
//     inputBeratBahan.value = beratBahan;
//     inputBeratBahan.disabled = true;
//     inputBeratBahan.className = "w-16 optional:text-gray-800 optional:text-xs bg-transparent border border-gray-400 hover:border-gray-500 px-1 py-2 rounded leading-tight focus:outline-none";
